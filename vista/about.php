          ...
          <section class="first hidden"> 
            <img id="img-ini " class="img-fluid img-ini" src="img/presentacion.png" alt=""> 
             ...
             <div class="container-fluid hidden">
                  <div class="row">
                   <div class="col-lg-4 col-md-4 col-12  img_one wow fadeInLeft text-center">
                     <img class="img-fluid iright " id="img-right"  src="img/right-img.webp" alt="">
                    </div>
                  ...
                  <div class="col-md-4 col-lg-4 col-12  img_two wow slideInDown">
                    <img class="img-fluid ileft " id="img-left" src="img/img-left.webp" alt="">
                 </div>
                 </div>
               </div>
        </div>
...
=======
        <div class="col-6 col-lg-4 col-md-6  mob20 wow zoomInRight img-intro">
           <img class="img-fluid about-img " id="parallax-img" src="img/right-img-about.webp" alt="">
>>>>>>> Stashed changes
